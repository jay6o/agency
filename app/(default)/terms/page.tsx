...
export const metadata: Metadata = {
	title: "Terms of Service | Attila Digital",
			...
			<div className="min-h-screen h-fit flex flex-col items-center py-36">
				<div className="w-5/6 lg:w-1/2">
					...
					<div className="overview py-4">
						...
						<p className="py-2">This website is operated by Attila Digital. Throughout the site, the terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer to Attila Digital. Attila Digital offers this website, including all information,
					...
					<div className="limited-liability py-4">
						...
						<p className="py-2">You agree that from time to time we may remove the service for indefinite periods of time or cancel the service at any time, without notice to you.
							...
							In no case shall Attila Digital, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any
					...
					<div className="indemnification py-4">
						...
						<p className="py-2">You agree to indemnify, defend and hold harmless Attila Digital and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors,
